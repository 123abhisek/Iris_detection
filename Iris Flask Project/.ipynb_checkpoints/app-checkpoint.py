...
def index():
   ...
   if request.method == 'POST':
      ...
      if file:
         ...
         #    "Habitat":Habitat
         # }
         return render_template('display.html',Class_Name="Class_Name",Varieties="Varieties",Facts="Facts",Uses="Uses",Petals="Petals",Sepals="Sepals",Flowers="Flowers",Leaves="Leaves",Height="Height",Habitat="Habitat")
